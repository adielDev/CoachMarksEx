 ...
 */
public class WishTripPunchHoleView extends LinearLayout {
    ...
    private OnClickListener mNextBtnClickListener;
    private OnClickListener mPrevBtnClickListener;
    private HashMap<Integer ,Integer> viewsKey;
    int currentView;

    public WishTripPunchHoleView(Context context, AttributeSet attrs) {
        super(context, attrs);
  ...
  public WishTripPunchHoleView(Context context) {
        super(context);
      ...
      currentView=0;
        ...
        inflater.inflate(R.layout.wish_trip_punch_hole_layout,this);
